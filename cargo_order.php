			...
			// Form Validation 
			  ...
			  if(isset($_POST['submit'])){
				...
				if(empty($_POST ['Depature'])){
				  $data_missing[]="Required Depature";

				}else if(!PREG_MATCH('/^[a-zA-Z\s]+$/',$_POST ['Depature'])){ 		//Depature must contain only characters 
				   $data_missing[]="Depature Must be Characters.";
				}
				else{
				...
				if(empty($_POST ['Destination'])){
				  $data_missing[]="Required Arrival";
				}
				else if(!PREG_MATCH('/^[a-zA-Z\s]+$/',$_POST ['Destination'])){ 	//Arrival must contain only characters 
				...
				$data_missing[] = "Required Sender name ";
				}else if(!PREG_MATCH('/^[a-zA-Z\s]+$/',$_POST ['Sender_name'])){ 	//Sender name must contain only characters 
				...
				if(empty($_POST ['Receiver_name'])){
				 $data_missing[] = "Required Receiver name";
				}else if(!PREG_MATCH('/^[a-zA-Z\s]+$/',$_POST ['Receiver_name'])){ 		//Receiver must contain only characters 
				   $data_missing[]="Sender name Must be Characters.";
				}
				else{
				...
				if(empty($_POST ['model'])){
				  $data_missing[]="Model Field are Empty";
				}else{
